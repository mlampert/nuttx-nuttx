...
int MLX90640_DumpEE(MLX90640_dev_t *dev, uint16_t *eeData)
{
     return MLX90640_I2CRead(&dev->nx, 0x2400, 832, eeData);
}

int MLX90640_CheckInterrupt(MLX90640_dev_t *dev)
{
    uint16_t statusRegister;
    MLX90640_I2CRead(&dev->nx, 0x8000, 1, &statusRegister);
    return (statusRegister & 0b1000) > 0;
}

void MLX90640_StartMeasurement(MLX90640_dev_t *dev, uint8_t subPage)
{
    uint16_t controlRegister1;
    uint16_t statusRegister;
    MLX90640_I2CRead(&dev->nx, 0x800D, 1, &controlRegister1);
    controlRegister1 &= 0b1111111111101111;
    controlRegister1 |= subPage << 4;
    MLX90640_I2CWrite(&dev->nx, 0x800D, controlRegister1);
    MLX90640_I2CRead(&dev->nx, 0x8000, 1, &statusRegister);
    ...
    MLX90640_I2CWrite(&dev->nx, 0x8000, statusRegister);
}

int MLX90640_GetData(MLX90640_dev_t *dev, uint16_t *frameData)
{
    int error = 0;
    uint16_t statusRegister;
    uint16_t controlRegister1;
    ...
    // Get page data
    error = MLX90640_I2CRead(&dev->nx, 0x0400, 832, frameData);
...
int MLX90640_GetFrameData(MLX90640_dev_t *dev, uint16_t *frameData)
{
    ...
    while(dataReady == 0)
    {
        error = MLX90640_I2CRead(&dev->nx, 0x8000, 1, &statusRegister);
        if(error != 0)
        {
            return error;
        }    
    ...
    { 
        error = MLX90640_I2CWrite(&dev->nx, 0x8000, 0x0030);
        if(error == -1)
        {
            return error;
        }
    ...
    error = MLX90640_I2CRead(&dev->nx, 0x800D, 1, &controlRegister1);
    frameData[832] = controlRegister1;
...
int MLX90640_SetResolution(MLX90640_dev_t *dev, uint8_t resolution)
{
    uint16_t controlRegister1;
    int value;
    int error;
    ...
    if(error == 0)
    {
        ...
        error = MLX90640_I2CWrite(&dev->nx, 0x800D, value);        
    }    
...
int MLX90640_GetCurResolution(MLX90640_dev_t *dev)
{
    uint16_t controlRegister1;
    int resolutionRAM;
    int error;
...
int MLX90640_SetRefreshRate(MLX90640_dev_t *dev, uint8_t refreshRate)
{
    uint16_t controlRegister1;
    int value;
    int error;
...
int MLX90640_GetRefreshRate(MLX90640_dev_t *dev)
{
    uint16_t controlRegister1;
    int refreshRate;
    int error;
...
int MLX90640_SetInterleavedMode(MLX90640_dev_t *dev)
{
    uint16_t controlRegister1;
    int value;
    int error;
...
int MLX90640_SetChessMode(MLX90640_dev_t *dev)
{
    uint16_t controlRegister1;
    int value;
    int error;
...
int MLX90640_GetCurMode(MLX90640_dev_t *dev)
{
    uint16_t controlRegister1;
    int modeRAM;
    int error;
...
int MLX90640_SetDeviceMode(MLX90640_dev_t *dev, uint8_t deviceMode)
{
    uint16_t controlRegister1;
    int value;
    int error;
...
int MLX90640_SetSubPageRepeat(MLX90640_dev_t *dev, uint8_t subPageRepeat)
{
    uint16_t controlRegister1;
    int value;
    int error;
...
int MLX90640_SetSubPage(MLX90640_dev_t *dev, uint8_t subPage)
{
    uint16_t controlRegister1;
    int value;
    int error;
